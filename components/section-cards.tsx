...
const SectionCards: NextPage = memo(() => {
  return (
    <section
      className="self-stretch h-[67.13rem] flex flex-col items-center justify-start z-[5] text-left text-[1rem] text-white-prime font-plus-jakarta-sans"
      id="SectionCards"
    >
      <div className="self-stretch flex flex-row items-center justify-center gap-[1.13rem] lg:flex-row lg:gap-[1.13rem] lg:items-center lg:justify-start md:flex-row md:gap-[1.13rem] md:items-center md:justify-start sm:flex-row sm:gap-[1.13rem] sm:items-center sm:justify-center">
        <div className="h-[52.13rem] shrink-0 flex flex-col items-start justify-start">
          <div className="self-stretch flex-1 flex flex-col items-center justify-end relative gap-[0.63rem]">
            <div className="my-0 mx-[!important] absolute top-[0rem] left-[0rem] w-[35.44rem] h-[52.13rem] flex flex-col items-center justify-center z-[0]">
              <div className="relative rounded-xl bg-grey-25 [backdrop-filter:blur(50px)] box-border w-[34.44rem] h-[51.13rem] opacity-[0.6] mix-blend-multiply border-[2px] border-solid border-grey-prime" />
            </div>
            <img
              ...
              src="/doctors@2x.png"
            />
            <div className="self-stretch h-[22rem] flex flex-col items-start justify-end py-[0rem] pr-[0rem] pl-[3.06rem] box-border gap-[1.94rem] z-[2]">
              <div className="flex flex-col items-start justify-start p-[0.5rem]">
                <b className="relative tracking-[0.1em] leading-[100%] flex items-center w-[5.75rem] h-[0.88rem] shrink-0 mix-blend-normal">
                  DOCTORS
                </b>
              </div>
              <div className="relative text-[3rem] leading-[110%] inline-block w-[23.88rem] h-[6.48rem] shrink-0">
                <span>{`Your practice, `}</span>
                <i className="font-semibold font-lora">upgraded.</i>
              </div>
            </div>
            <div className="self-stretch h-[22rem] flex flex-row items-center justify-start pt-[6.38rem] pb-[8.88rem] pr-[0rem] pl-[3.06rem] box-border z-[3] text-[1.5rem] text-white">
            ...
            <div className="w-[34.56rem] h-[6rem] flex flex-col items-center justify-start gap-[0.63rem] z-[4] text-center text-[1.13rem] text-green-prime">
              <button
