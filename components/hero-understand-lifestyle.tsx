...
const HeroUnderstandLifestyle: NextPage = memo(() => {
  return (
    <section
      className="self-stretch h-[67.5rem] flex flex-col items-center justify-center py-[0rem] px-[15.94rem] box-border z-[2] text-left text-[4.88rem] text-grey-prime font-lora"
      id="HeroUnderstandLifestyle"
    >
      <div className="self-stretch flex flex-row items-start justify-start lg:flex-row lg:gap-[0rem] lg:items-start lg:justify-start md:flex-row md:gap-[0rem] md:items-start md:justify-start sm:flex-col sm:gap-[0rem] sm:items-start sm:justify-start">
